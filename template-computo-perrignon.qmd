...
![Comparison of the Pareto Fronts obtained for each stopping criterion with the simulated Pareto Front.](figures/Figure3.png){#fig-3}
...
![Evolution of hypervolume over generations for industrial optimization for Y = 4 with the stopping generation proposed by each stopping criterion.](figures/Figure9.png){#fig-9}
...
![Evolution of hypervolume over generations for WFG1 problem for Y = 2 with the stopping generation proposed by each stopping criterion.](figures/Figure10.png){#fig-10}
